...
import xyz.kiridepapel.fraxianimebackend.dto.PageDTO.DirectoryOptionsDTO;
...
public class LfDirectoryService {
  // Variables estaticas
  ...
  public DirectoryOptionsDTO directoryOptions(String options) {
    ...
    List<String> removeNamesList = List.of(
      // Varios
      "Todo",
      // Tipo
      "BD",
  ...
  public List<AnimeDataDTO> directoryAnimes(String uri) {
