...
// @Service
// @Log
// public class ChapterAnimeFlvService {
//   @Value("${PROVEEDOR_ANIMEFLV_URL}")
//   private String proveedorAnimeFlvUrl;

//   public ChapterDTO specificChapter(String inputName, String chapter) {
//     try {
...
//       ChapterDTO animeInfo = ChapterDTO.builder()
...
//       link.setUrl(ZMethods.decodeBase64(element.attr("data-src"), false));
...
//       return (urlAnimeInfo + "/" + (actualChapterInt - 1)).replace(this.proveedorAnimeFlvUrl, "");
...
//       String nextChapterUrl = (urlAnimeInfo + "/" + (actualChapterInt + 1)).replace(this.proveedorAnimeFlvUrl, "");
//       if (chapters == 0) {
