...
import xyz.kiridepapel.fraxianimebackend.interfaces.IJkTopService;
...
@Service
@Log
public class JkTopServiceImpl implements IJkTopService {
  // Variables estaticas
  ...
  // Constructor
  public JkTopServiceImpl(TranslateServiceImpl translateService, AnimeUtils animeUtils, CacheUtils cacheUtils) {
