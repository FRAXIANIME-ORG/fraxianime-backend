...
public class DataServiceImpl<T> implements IDataService {
  @Data
  ...
  private final JkTopServiceImpl jkTopService;
  // ? Repositories
  private final AnimeDaoRepository animeRepository;
  private final SpecialCaseDaoRepository specialCaseRepository;

  // Constructor
  public DataServiceImpl(DatabaseUtils databaseUtils, CacheManager cacheManager, JkTopServiceImpl jkTopService,
      AnimeDaoRepository animeRepository, SpecialCaseDaoRepository specialCaseRepository) {
    this.databaseUtils = databaseUtils;
    this.cacheManager = cacheManager;
    this.jkTopService = jkTopService;
