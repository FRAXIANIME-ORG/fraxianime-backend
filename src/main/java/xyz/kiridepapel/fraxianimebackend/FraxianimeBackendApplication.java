  ...
  public CommandLineRunner initData(
    ...
    return args -> {
      ...
      if (specialCaseRepository.count() == 0) {
        ...
        // s
        specialCases.add(new SpecialCaseEntity(null, 's', "maou-gakuin-no-futekigousha", "maou-gakuin-no-futekigousha-shijou-saikyou-no-maou-no-shiso-tensei-shite-shison-tachi-no-gakkou-e"));
